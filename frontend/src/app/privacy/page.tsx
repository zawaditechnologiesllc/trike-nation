    ...
    <PageShell kicker="Legal" title="Privacy Policy">
      ...
      <Section title="What We Collect">
        <p>
          ...
          see or store your card number — payments are processed by our payment providers.
        </p>
      </Section>
      <Section title="How We Use It">
        <p>
          Order fulfillment, shipping notifications, warranty service, and — only if you opt in —
          the Join the Nation newsletter. We do not sell or rent your personal information to
          anyone, ever.
        </p>
      </Section>
